...
namespace Logisticsm.ViewModels
{
    public class ViewModelLocator
	{
		...
		public ExpressTransportViewModel ExpressTransport => App.ServiceProvider.GetRequiredService<ExpressTransportViewModel>();
		public AddExpressTransportViewModel AddExpressTransport => App.ServiceProvider.GetRequiredService<AddExpressTransportViewModel>();
		public EditExpressTransportViewModel EditExpressTransport => App.ServiceProvider.GetRequiredService<EditExpressTransportViewModel>();
	}
}
